...
do
    wget -P ${localpath} ${server}/${latest}/fpgas/cs/${P}/build/${P}_top.svf
    echo ${P} finished
done
...
for P in cs10
do
    wget -P ${localpath} ${server}/${biteth}/fpgas/cs/${P}/build/${P}_top.svf
    echo ${P} finished
done
...
for P in cs20
do
    wget -P ${localpath} ${server}/${bitcs20}/fpgas/cs/${P}/build/${P}_top.svf
    echo ${P} finished
done
