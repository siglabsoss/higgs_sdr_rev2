...
module tb;
    ...
    big_ass_fifo u1 (.Data(Data), .Clock(Clock), .WrEn(WrEn), .RdEn(RdEn), 
    ...
    begin
       Data <= 0;
      for (i1 = 0; i1 < 65540; i1 = i1 + 1) begin
        @(posedge Clock);
        #1  Data <= Data + 1'b1;
      end
    end
    ...
    begin
      ...
      #100;
      @(Reset == 1'b0);
      for (i3 = 0; i3 < 65540; i3 = i3 + 1) begin
        @(posedge Clock);
        #1  WrEn <= 1'b1;
      end
       WrEn <= 1'b0;
    ...
    begin
      ...
      @(WrEn == 1'b1);
      @(WrEn == 1'b0);
      for (i4 = 0; i4 < 65538; i4 = i4 + 1) begin
        @(posedge Clock);
        #1  RdEn <= 1'b1;
      end
       RdEn <= 1'b0;
