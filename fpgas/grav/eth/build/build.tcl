...
set impl_name "impl1" 
set top_name "eth_top";                                     # NOTE: bit file location & name will be ./impl_dir/top_name_impl_name.bit
set lpf_file "eth_top.lpf";                                 # Lattice Logical Preferences

set syn_constraints "no";                                   # yes = pass Synplify specific constraints file to Synplify, no = no Synplify specific constraints file
set syn_constraints_file "eth_top.fdc";                     # Synplify synthesis constraints (optional)

set insert_debug "no";                                     # yes = insert reveal debug core, no = skip debug core insertion
# set debug_file "eth_to_cs_cmd.rvl";                               # project file for Reveal Analyzer cores to insert 
#set debug_file "eth_top.rvl";                               # project file for Reveal Analyzer cores to insert 
set debug_file "debug_offchip.rvl";                        # for offchip / half clock debugging
...
# prj_strgy set_value par_place_iterator=5 par_routeing_pass=1;
...
file copy -force $impl_dir/$top_name\_$impl_name.tw1 ./reports/map_timing_report.txt; # MapTrace timing report
...
#cd ./reports
#htmlrpt -syn ./synth_report.txt -mrp ./map_report.txt -mtwr ./map_timing_report.txt -pad ./pad_report.txt -par ./par_report.txt -ptwr ./timing_report.txt -bgn ./bitgen_report.txt all_reports
#cd ../
