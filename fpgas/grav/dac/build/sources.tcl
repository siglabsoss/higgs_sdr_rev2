...
prj_src add ../hdl/dac_top.sv
prj_src add ../hdl/dac_data_tx.sv
prj_src add ../hdl/data_generator.sv
prj_src add ../hdl/regs.sv
prj_src add ../ip/lattice/dac_tx_2x_ddr/dac_tx_2x_ddr.v

file copy -force ../hdl/tone.mif ./tmp/tone.mif 
#
# EXTERNAL MODULES & IP
#
...
source $ip_lib_path/mib_bus/diamond_sources.tcl;                                         # mib slave
...
source $ip_lib_path/upconverter/diamond_sources.tcl;                                     # upconverter (only used for interpolation filter inside)
