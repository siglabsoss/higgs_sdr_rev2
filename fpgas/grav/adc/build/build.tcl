...
set impl_name "impl1"
set top_name "adc_top";                                     # NOTE: bit file location & name will be ./impl_dir/top_name_impl_name.bit
set lpf_file "adc_top.lpf";                                 # Lattice Logical Preferences
...
#prj_strgy set_value par_pathbased_place=On;                              # See: Lattice Diamond -> Project -> Active Strategy -> Place and Route Design Settings 
#prj_strgy set_value par_place_iterator=5 par_place_iterator_start_pt=25 par_stop_zero=True;                              # See: Lattice Diamond -> Project -> Active Strategy -> Place and Route Design Settings 
