...
vlog -work work     ../ip/cs11_pll/cs11_pll.v
vlog -work work -sv ../hdl/cs11_cmd.sv
vlog -work work -sv ../hdl/resetter.sv
vlog -work work -sv tb_cs11_top.sv
vlog -work work -sv ../hdl/cs11_top.sv

vsim -t 1ps -L pmi_work -L ecp5u_vlg -voptargs=+acc tb_cs11_top
