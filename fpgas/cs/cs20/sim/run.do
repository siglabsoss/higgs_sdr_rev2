...
vlog -work work     ../ip/cs20_pll/cs20_pll.v
vlog -work work -sv ../hdl/cs20_cmd.sv
vlog -work work -sv ../hdl/resetter.sv
vlog -work work -sv tb_cs20_top.sv
vlog -work work -sv ../hdl/cs20_top.sv

vsim -t 1ps -L pmi_work -L ecp5u_vlg -voptargs=+acc tb_cs20_top
