...
vlog -work work     ../ip/cs21_pll/cs21_pll.v
vlog -work work -sv ../hdl/cs21_cmd.sv
vlog -work work -sv ../hdl/resetter.sv
vlog -work work -sv tb_cs21_top.sv
vlog -work work -sv ../hdl/cs21_top.sv

vsim -t 1ps -L pmi_work -L ecp5u_vlg -voptargs=+acc tb_cs21_top
