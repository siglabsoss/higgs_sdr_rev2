...
vlog -work work     ../ip/cscfg_pll/cscfg_pll.v
vlog -work work -sv ../hdl/cscfg_top.sv
vlog -work work -sv ../hdl/mib_cdc.sv
vlog -work work -sv cscfg_cmd.sv
vlog -work work -sv mib_slave_wrapper.sv
vlog -work work -sv tb_cscfg_top.sv

vsim -t 1ps -L pmi_work -L ecp5u_vlg -voptargs=+acc tb_cscfg_top
