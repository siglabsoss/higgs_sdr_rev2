...
vlog -work work     ../ip/cs03_pll/cs03_pll.v
vlog -work work -sv ../hdl/cs03_cmd.sv
vlog -work work -sv ../hdl/resetter.sv
vlog -work work -sv tb_cs03_top.sv
vlog -work work -sv ../hdl/cs03_top.sv

vsim -t 1ps -L pmi_work -L ecp5u_vlg -voptargs=+acc tb_cs03_top
