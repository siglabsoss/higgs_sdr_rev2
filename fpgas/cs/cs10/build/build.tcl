...
set impl_name "impl1"
set top_name "cs10_top";                                     # NOTE: bit file location & name will be ./impl_dir/top_name_impl_name.bit
set lpf_file "cs10_top.lpf";                                 # Lattice Logical Preferences

set syn_constraints "no";                                   # yes = pass Synplify specific constraints file to Synplify, no = no Synplify specific constraints file
set syn_constraints_file "cs10_top.fdc";                     # Synplify synthesis constraints (optional)

set insert_debug "no";                                      # yes = insert reveal debug core, no = skip debug core insertion
set debug_file "cs10_top.rvl";                               # project file for Reveal Analyzer cores to insert
