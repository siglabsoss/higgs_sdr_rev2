...
void loworder2skewoneplus(int start_row, int num_row);
...
void nop_gap(int num);
int skewoneplus2loworder(int start_row, int num_row);
void data_show(int start_address, int num_data);
int result_check(int benchmark_start_row, int result_start_row, int total_sample);
...
unsigned int hash_add(unsigned int *state, unsigned int len)
{
...
void xbb_1024fft()
{
  ...
  // row index
  int cfg_location = VMEM_ADDRESS(data_cfg);
  int twddle_location_0 = VMEM_ADDRESS(tw0);
  int twddle_location_1 = VMEM_ADDRESS(tw1);
  int twddle_location_2 = VMEM_ADDRESS(tw20);
  int twddle_location_3 = VMEM_ADDRESS(tw30);;
  int twddle_location_4 = VMEM_ADDRESS(tw400);;
  int bank_address_location_0 = VMEM_ADDRESS(bank_address_0);
  int bank_address_location_1 = VMEM_ADDRESS(bank_address_1);
  int permutation_address_location_1 = VMEM_ADDRESS(permutation_address_1);
  int bank_address_location_2 = VMEM_ADDRESS(bank_address_2);
  int bank_address_location_3 = VMEM_ADDRESS(bank_address_3);
  int permutation_address_location_3_LK9 = VMEM_ADDRESS(permutation_address_3_LK9);
  int permutation_address_location_3_SK1 = VMEM_ADDRESS(permutation_address_3_SK1);
  int bank_address_location_4 = VMEM_ADDRESS(bank_address_4);
  int result_location = VMEM_ADDRESS(fft_results_4);
  int data_location = VMEM_ADDRESS(fft_data);
  int data_location_0 = VMEM_ADDRESS(out_data_0);
  // int data_location_1 = data_location_0 + 64;
  // int data_location_2 = data_location_1 + 64;
  // int data_location_3 = data_location_2 + 64;
  // int data_location_4 = data_location_3 + 64;
  
  

  // reordering
  loworder2skewoneplus(data_location, 64);
  ...
  skewoneplus2loworder(data_location_0, 64);
  ...
  //data_show(data_location_0, 1024);
  
  //check results
  *pass_fail_0=0x00000000;
  int flag = result_check(result_location, data_location_0, 1024);
  if(flag==1)
...
void reordering_1024_loworder2skewoneplus(int source_address, int destination_address, int bank_address_location_0)
{
  ...
  for(int index_row = 0; index_row<latency; index_row++)
    ...
    for(int index_row = 0; index_row<4; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+index*16));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
      ...
      for(int index_row = 0; index_row<4; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+4+index*16));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
    ...
    for(int index_row = 0; index_row<4; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+8+index*16));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
      ...
      for(int index_row = 0; index_row<latency; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+(16-latency)+index*16));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
      ...
      MV_KNOP(V6, V0, 0);
      MVXV_KNOP(V2, (16-(((index+1)*16)>>4))<<12);
    ...
    for(int index_row = 0; index_row<4; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+48));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
     ...
     for(int index_row = 0; index_row<4; index_row++)
    {
      ...
      MVXV_KNOP(V1, destination_address+(index_row+52));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
     ...
     for(int index_row = 0; index_row<8-latency; index_row++)
    {
      ADD_KNOP(V1, V3, V6, 0);
      ADD_KNOP(V1, V1, V4, 0);
      MVXV_LK15(V1, 1, V1);
      ...
      MVXV_KNOP(V1, destination_address+(index_row+56));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
    ...
    for(int index_row = 0; index_row<latency;index_row++)
    {
      MVXV_KNOP(V1, destination_address+(index_row+64-latency));
      ADD_KNOP(V1, V1, V2, 0);
      VNOP_SK15(V1);
...
void fft1024_1(int data_location_0, int twddle_location_1, int permutation_address_location_1)
{
  ...
  const int latency_1 = 4; //this number cannot change
  ...
  for(int index_stage1=0;index_stage1<3;index_stage1++)
  {
    ...
    {
     MVXV_LK8(V1, data_location_0+(latency_1+index+index_stage1*16), V0);

     ADD_KNOP(V1, V1, V5, 0);
     MVXV_LK9(V2, data_location_0+index+index_stage1*16, V1);
    ...
    for(int index=0; index<latency_1; index++)
    {
     MVXV_LK8(V1, data_location_0+(16+index+index_stage1*16), V0);

     ADD_KNOP(V1, V1, V5, 0);
     MVXV_LK9(V2, data_location_0+(16-latency_1)+index+index_stage1*16, V1);
  ...
  for(int index=0;index<16-latency_1;index++)
  {
    MVXV_LK8(V1, data_location_0+(48+latency_1+index), V0);

    ADD_KNOP(V1, V1, V5, 0);
    MVXV_LK9(V2, data_location_0+48+index, V1);
  ...
  for(int index=0;index<latency_1;index++)
  {
    MVXV_KNOP(V2, data_location_0+(64-latency_1)+index);
...
void fft1024_2(int data_location_0, int twddle_location_2, int bank_address_location_2)
{
  ...
  {
    MVXV_KNOP(V3, twddle_location_2+(index%4)); //twddle factor
    MVXV_LK8(V3, data_location_0, V3);
    ADD_KNOP(V2, V0, V3, 0);
    ADD_KNOP(V1, V2, V4, 0);
    ROL_LK9(V0, V1, V0, 0);
  ...
  {
    for(int index=0; index<(16-latency_2); index++)
    {
      MVXV_KNOP(V3, twddle_location_2+(index%4)); //twddle factor
      MVXV_LK8(V3, data_location_0+((index_stage2*16+index+latency_2)>>2)*4, V3);
      ADD_KNOP(V2, V0, V3, 0);
      ADD_KNOP(V1, V2, V4, 0);
      ROL_LK9(V0, V1, V0, 0);
      
      MVXV_KNOP(V3, data_location_0+((index_stage2*16+index)>>2)*4);
      ADD_KNOP(V2, V7, V3, 0);
      ADD_KNOP(V1, V2, V6, 0);
      ROL_SK1(V7, V1, V7, 0);
    ...
    {
      MVXV_KNOP(V3, twddle_location_2+(index%4)); //twddle factor
      MVXV_LK8(V3, data_location_0+((index_stage2*16+index+16)>>2)*4, V3);
      ADD_KNOP(V2, V0, V3, 0);
      ADD_KNOP(V1, V2, V4, 0);
      ROL_LK9(V0, V1, V0, 0);
      
      MVXV_KNOP(V3, data_location_0+((index_stage2*16+index+16-latency_2)>>2)*4);
      ADD_KNOP(V2, V7, V3, 0);
      ADD_KNOP(V1, V2, V6, 0);
      ROL_SK1(V7, V1, V7, 0);
  ...
  {
    MVXV_KNOP(V3, twddle_location_2+(index%4)); //twddle factor
    MVXV_LK8(V3, data_location_0+((48+latency_2+index)>>2)*4, V3);
    ADD_KNOP(V2, V0, V3, 0);
    ADD_KNOP(V1, V2, V4, 0);
    ROL_LK9(V0, V1, V0, 0);
      
    MVXV_KNOP(V3, data_location_0+((48+index)>>2)*4);
    ADD_KNOP(V2, V7, V3, 0);
    ADD_KNOP(V1, V2, V6, 0);
    ROL_SK1(V7, V1, V7, 0);
  ...
  for(int index=0; index<latency_2; index++)
  {
    MVXV_KNOP(V3, data_location_0+((64-latency_2+index)>>2)*4);
    ADD_KNOP(V2, V7, V3, 0);
    ADD_KNOP(V1, V2, V6, 0);
    ROL_SK1(V7, V1, V7, 0);
...
void fft1024_3(int data_location_0, int twddle_location_3, int bank_address_location_3, int permutation_address_location_3_LK9, int permutation_address_location_3_SK1)
{
  ...
  {
    MVXV_KNOP(V5, (index_stage3<<12));
    MV_KNOP(V0, V7, 0);
  
    for(int index=0;index<16;index++)
    {
      
      MVXV_KNOP(V4, permutation_address_location_3_LK9+index);
      VNOP_LK15(V4);
      MVK15V_KNOP(V4,0);
      ADD_KNOP(V4, V4, V5, 0);
    
      MVXV_KNOP(V6, permutation_address_location_3_SK1+index);
      VNOP_LK15(V6);
      MVK15V_KNOP(V6,0);
      for(int ii=0;ii<index_stage3;ii++)
      {
        ROL_KNOP(V6, V6, 0);
      }
      SUB_KNOP(V6, V6, V5, 0);
...
void fft1024_4(int data_location_0, int twddle_location_4, int bank_address_location_4)
{
  ...
  for(int index_stage4=0; index_stage4<4; index_stage4++)
  {
    ...
    for(int index=0;index<16;index++)
    {
      ...
      MVXV_KNOP(V3, twddle_location_4+index_stage4*16+index); 
      MVXV_LK8(V3, data_location_0, V3);
      ADD_KNOP(V2, V0, V3, 0);
      ADD_KNOP(V1, V2, V4, 0);
      VNOP_LK9(V1);
  ...
  // MV_KNOP(V5, V7, 0);
  // const int latency_4=4; //this number cannot change

  // for(int index=0;index<latency_4;index++)
  // {
  //   MV_KNOP(V0, V7, 0);

  //   MVXV_KNOP(V3, twddle_location_4+index); 
  //   MVXV_LK8(V3, data_location_0, V3);
  //   ADD_KNOP(V1, V0, V3, 0);
  //   ADD_KNOP(V1, V1, V4, 0);
  //   VNOP_LK9(V1);
...
int main(void)
{
  // This fft uses 1-skew plus. However, additional 64-row verctor meory is still needed for reordering after finishing 5 stages.  
  // Reordering is done first.
