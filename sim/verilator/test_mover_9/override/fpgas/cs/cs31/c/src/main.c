...
unsigned int packet_SFO_adjustment_nco_freq = 0;
   ...
   // if(1)
    {
        ...
        if((nco_ready_indi == 1) ||(nco_ready_indi == 0))
        {
            ...
            if(((rbus_omega_sign == 0) && (packet_SFO_adjustment_direction == 1)) || ((rbus_omega_sign == 1) && (packet_SFO_adjustment_direction == 2)))
            {
...
void cfo_turnoff_callback(unsigned int data)
{
