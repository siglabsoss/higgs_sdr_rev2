...
int main(int argc, char** argv, char** env) {
  ...
  cs21_node_t* cs21_node = top->tb_higgs_top->cs21_top->vex_machine_top_inst->q_engine_inst->piston_inst->UNODE_NAME;
  cs31_node_t* cs31_node = top->tb_higgs_top->cs31_top->vex_machine_top_inst->q_engine_inst->piston_inst->UNODE_NAME;
  cs30_node_t* cs30_node = top->tb_higgs_top->cs30_top->vex_machine_top_inst->q_engine_inst->piston_inst->UNODE_NAME;

  // file_dump_T<cs30_node_t>(cs30_node, "cs30.out");
  file_dump_T<cs21_node_t>(cs21_node, "cs21.out");
  file_dump_T<cs31_node_t>(cs31_node, "cs31.out");
  file_dump_T<cs30_node_t>(cs30_node, "cs30.out");
