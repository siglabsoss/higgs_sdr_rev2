...
//   for(i = 0; i < 1024; i++)
//   {
//     vector_memory[i] = dmem_sin1[i];
//     if(i<=3)
//       vector_memory[i] = 0x00007fff;
//     else
//       vector_memory[i] = 0x0;
//   }
...
//   ring_block_send_eth(0x8f000000|1);
...
//     ring_block_send_eth(0x8f000000|samples_saturated&0xffff);
//     ring_block_send_eth(0x8f000000|((samples_saturated>>16)&0xffff));
