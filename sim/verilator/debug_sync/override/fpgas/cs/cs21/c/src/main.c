...
void dma_block_send_sliced(unsigned int dma_ptr, unsigned int word_count, unsigned int slice_type) {
...
#else
    dma_block_send_sliced(DST_ROW_REV2*NSLICES, 128, 1);
