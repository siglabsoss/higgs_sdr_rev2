    ...
    const unsigned int phase_mode ) // from global phase_correction_mode
{
   ...
   input_trunk[TRUNK_R0_CFO] = vector_memory[VMEM_ROW_ADDRESS_TO_DMA(input_data_location)+1024+TRUNK_R0_CFO];
   input_trunk[TRUNK_R1_CFO] = vector_memory[VMEM_ROW_ADDRESS_TO_DMA(input_data_location)+1024+TRUNK_R1_CFO];
   ...
   vector_memory[VMEM_ROW_ADDRESS_TO_DMA(output_data_location)+1024+TRUNK_R1_SFO] = input_trunk[TRUNK_R1_SFO];
    ...
    if (cooked_data_type != 2) {
        ...
        if( (duplex_mode_rx == DUPLEX_SEND_UL_DATA) ) {
            vector_memory[VMEM_ROW_ADDRESS_TO_DMA(output_data_location)+1024+TRUNK_R0_CFO] = input_trunk[TRUNK_R0_CFO];
            vector_memory[VMEM_ROW_ADDRESS_TO_DMA(output_data_location)+1024+TRUNK_R1_CFO] = input_trunk[TRUNK_R1_CFO];
        } else {
            vector_memory[VMEM_ROW_ADDRESS_TO_DMA(output_data_location)+1024+TRUNK_R0_CFO] = 0;
            vector_memory[VMEM_ROW_ADDRESS_TO_DMA(output_data_location)+1024+TRUNK_R1_CFO] = 0;
        }
   }
