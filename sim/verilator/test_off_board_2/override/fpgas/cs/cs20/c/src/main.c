...
#define FEEDBACK_BUS_USER_POINTERS (30)
...
#define FORCE_INITIAL_TIMER {0x304d,6144-8-4-4-7-6}
...
int main(void)
{
    ...
    // dma_block_send(VMEM_DMA_ADDRESS(threek), 1024);
    // dma_block_send(VMEM_DMA_ADDRESS(threek), 1024);
    // dma_block_send(VMEM_DMA_ADDRESS(vector_a), 1024);
    // dma_block_send(VMEM_DMA_ADDRESS(vmem_zeros), 1024);
    // dma_block_send(VMEM_DMA_ADDRESS(vector_a), 1024);
    // dma_block_send(VMEM_DMA_ADDRESS(vmem_zeros), 1024);
