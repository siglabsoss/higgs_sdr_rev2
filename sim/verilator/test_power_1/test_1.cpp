...
void test1(int argc, char** argv, char** env) {
    ...
    auto gotPower = [&](const uint64_t p) {
        ...
        cout << "\n\nGot power: " << HEX64_STRING(pw) << "  (" << pw << ") " << "  with a shift of " << shift << msg << "\n";
        cout << "or       : " << (double) (pw << shift) << "\n\n";
    };
