...
gtkwave::/Edit/Insert_Comment "--- CS00 PC ---"
lappend cs00pc "TOP.tb_higgs_top.cs00_top.vex_machine_top_inst.q_engine_inst.VexRiscv.VexRiscv.system_cpu.writeBack_PC"
set num_added [ gtkwave::addSignalsFromList $cs00pc ]

gtkwave::/Edit/Insert_Comment "--- CS01 PC ---"
lappend cs01pc "TOP.tb_higgs_top.cs01_top.vex_machine_top_inst.q_engine_inst.VexRiscv.VexRiscv.system_cpu.writeBack_PC"
set num_added [ gtkwave::addSignalsFromList $cs01pc ]
