...
#     		 ],
      ...
      # ,
      # '<!@(ls -1 verilator/test_signalflip_1/obj_dir/*.cpp)'
      ],
#      'sources': '<!(["node", ])',
...
#      "./obj_dir"
     ...
     'libraries': [
     "../verilator/test_signalflip_1/obj_dir/verilator_global_libs.a"
     ,"../verilator/test_signalflip_1/obj_dir/Vtb_higgs_top__ALL.a"
